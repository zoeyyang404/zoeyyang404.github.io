...
- Predicting : eg: whatâ€™s the pupilsâ€™ grade next semester given his/her current performance.
...
Directly building a model with all variables is not sensible, especially when the number of variables is large. And you donâ€™t want to explain something by irrelevant factors like explain a pupilâ€™s grade by the number of animals in the zoo. So, we only want relevant factors in our model.
